CREATE OR REPLACE FUNCTION {{SCHEMA}}.tx_utxos(_tx_hashes text [])
RETURNS TABLE (
  tx_hash text,
  inputs jsonb,
  outputs jsonb
...
COMMENT ON FUNCTION {{SCHEMA}}.tx_utxos IS 'Get UTXO set (inputs/outputs) of transactions.'; -- noqa: LT01
