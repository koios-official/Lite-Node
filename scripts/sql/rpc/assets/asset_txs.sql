CREATE OR REPLACE FUNCTION {{SCHEMA}}.asset_txs(
  _asset_policy text,
...
COMMENT ON FUNCTION {{SCHEMA}}.asset_txs IS 'Get the list of all asset transaction hashes (newest first)'; -- noqa: LT01
