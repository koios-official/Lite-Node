CREATE OR REPLACE FUNCTION {{SCHEMA}}.asset_history(_asset_policy text, _asset_name text DEFAULT '')
RETURNS TABLE (
  policy_id text,
  asset_name text,
...
COMMENT ON FUNCTION {{SCHEMA}}.asset_history IS 'Get the mint/burn history of an asset'; -- noqa: LT01
