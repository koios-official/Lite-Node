DROP VIEW IF EXISTS {{SCHEMA}}.blocks;

CREATE VIEW {{SCHEMA}}.blocks AS
SELECT
...
COMMENT ON VIEW {{SCHEMA}}.blocks IS 'Get detailed information about all blocks (paginated - latest first)';
