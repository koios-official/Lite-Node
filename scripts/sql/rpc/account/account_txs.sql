CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_txs(_stake_address text, _after_block_height integer DEFAULT 0)
RETURNS TABLE (
  tx_hash text,
  epoch_no word31type,
...
COMMENT ON FUNCTION {{SCHEMA}}.account_txs IS 'Get transactions associated with a given stake address'; -- noqa: LT01
