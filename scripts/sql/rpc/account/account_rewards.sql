CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_rewards(_stake_addresses text [], _epoch_no numeric DEFAULT NULL)
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.account_rewards IS 'Get the full rewards history (including MIR) for given stake addresses, or certain epoch if specified'; -- noqa: LT01
