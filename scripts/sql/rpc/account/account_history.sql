CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_history(_stake_addresses text [], _epoch_no integer DEFAULT NULL)
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.account_history IS 'Get the active stake history of given accounts'; -- noqa: LT01
