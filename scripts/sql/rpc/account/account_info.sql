CREATE OR REPLACE FUNCTION {{SCHEMA}}.account_info(_stake_addresses text [])
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.account_info IS 'Get the account info for given stake addresses'; -- noqa: LT01
