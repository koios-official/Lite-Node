CREATE OR REPLACE FUNCTION {{SCHEMA}}.block_tx_info(
  _block_hashes text[],
    ...
    WITH
      ...
      _all_collateral_inputs AS (
        ...
        FROM collateral_tx_in
          ...
          LEFT JOIN {{SCHEMA}}.asset_info_cache AS aic ON _assets IS TRUE AND aic.asset_id = ma.id
...
COMMENT ON FUNCTION {{SCHEMA}}.block_tx_info IS 'Get information about transactions for given block hashes.'; -- noqa: LT01
