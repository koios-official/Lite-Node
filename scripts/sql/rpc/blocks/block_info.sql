CREATE OR REPLACE FUNCTION {{SCHEMA}}.block_info(_block_hashes text [])
RETURNS TABLE (
  hash text,
  epoch_no word31type,
  abs_slot word63type,
...
COMMENT ON FUNCTION {{SCHEMA}}.block_info IS 'Get detailed information about list of block hashes'; --noqa: LT01
