CREATE OR REPLACE FUNCTION {{SCHEMA}}.pool_registrations(_epoch_no numeric)
RETURNS TABLE (
  pool_id_bech32 text,
  tx_hash text,
  block_hash text,
...
COMMENT ON FUNCTION {{SCHEMA}}.pool_registrations IS 'A list of all pool registrations initiated in the requested epoch'; --noqa: LT01
