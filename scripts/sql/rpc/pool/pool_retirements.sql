CREATE OR REPLACE FUNCTION {{SCHEMA}}.pool_retirements(_epoch_no numeric)
RETURNS TABLE (
  pool_id_bech32 text,
  tx_hash text,
  block_hash text,
...
COMMENT ON FUNCTION {{SCHEMA}}.pool_retirements IS 'A list of all pool retirements initiated in the requested epoch'; --noqa: LT01
