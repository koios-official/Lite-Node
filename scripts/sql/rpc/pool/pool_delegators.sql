CREATE OR REPLACE FUNCTION {{SCHEMA}}.pool_delegators(_pool_bech32 text)
RETURNS TABLE (
...
COMMENT ON FUNCTION {{SCHEMA}}.pool_delegators IS 'Return information about live delegators for a given pool.'; --noqa: LT01
