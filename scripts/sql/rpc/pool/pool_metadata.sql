CREATE OR REPLACE FUNCTION {{SCHEMA}}.pool_metadata(_pool_bech32_ids text [] DEFAULT null)
RETURNS TABLE (
...
BEGIN
  ...
  LEFT JOIN {{SCHEMA}}.pool_info_cache AS pic ON ph.view = pic.pool_id_bech32
...
COMMENT ON FUNCTION {{SCHEMA}}.pool_metadata IS 'Metadata(on & off-chain) for all pools'; -- noqa: LT01
